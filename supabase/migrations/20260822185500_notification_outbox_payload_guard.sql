  ...
  with claimed as (
    select o.tenant_id, o.id
     ...
     where o.delivered_at is null
       ...
       and jsonb_typeof(o.payload->'deliveryId') = 'string'
       and btrim(o.payload->>'deliveryId') <> ''
       and jsonb_typeof(o.payload->'recipientId') = 'string'
       and btrim(o.payload->>'recipientId') <> ''
       and jsonb_typeof(o.payload->'channel') = 'string'
       and o.payload->>'channel' in ('in-app','push','email','whatsapp')
       and jsonb_typeof(o.payload->'templateKey') = 'string'
       and btrim(o.payload->>'templateKey') <> ''
       and jsonb_typeof(o.payload->'locale') = 'string'
       and btrim(o.payload->>'locale') <> ''
