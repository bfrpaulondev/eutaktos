...
try {
  ...
  process.stdout.write('UX runtime checks passed: pt-PT/en/es workspaces, organization tabs/dialogs, dark/high contrast, 320px reflow, skip link, landmarks and aria-current.\n');
} finally {
  cdp?.close();
