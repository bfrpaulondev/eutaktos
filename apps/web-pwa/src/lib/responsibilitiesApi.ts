...
function assignBody(i:AssignResponsibilityPayload):AssignResponsibilityPayload{return{personId:i.personId,responsibilityKey:i.responsibilityKey,startsAt:i.startsAt,...(i.endsAt!==undefined?{endsAt:i.endsAt}:{})};}
