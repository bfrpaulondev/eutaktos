...
export function SectionWorkspace({ locale, section }: SectionWorkspaceProps) {
  ...
  return <Box component="section" aria-labelledby={`section-${section}-title`}>
    ...
    {section === 'assignments' ? <Alert severity="info" role="status" aria-live="polite">
      <Typography variant="subtitle2" fontWeight={700}>{text.assignmentsUnavailableTitle}</Typography>
      <Typography variant="body2">{text.assignmentsUnavailableDetail}</Typography>
