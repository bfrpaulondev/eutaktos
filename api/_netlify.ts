...
type RouteKey =
  ...
  | 'people' | 'people-directory' | 'people-overview-evidence' | 'people-assistance' | 'people-recommendations' | 'people-reminders' | 'people-contact-list' | 'people-record-cards' | 'people-transfers' | 'people-transfer-preview' | 'people-transfer-claim' | 'person' | 'person-archive' | 'eligibility' | 'availability' | 'ordinary-contact' | 'availability-period'
